...
namespace TeleDotNet.Tests
{
    public class TeleDotNetTests
    {
        ...
        public virtual async Task SignUpNewUser()
        {
            ...
            var registeredUser = await client.SignUpAsync(NotRegisteredNumberToSignUp, hash, code, "TeleDotNet", "User");
