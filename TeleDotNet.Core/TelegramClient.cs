...
using TeleDotNet.TL;
using TeleDotNet.TL.Account;
using TeleDotNet.TL.Auth;
using TeleDotNet.TL.Contacts;
using TeleDotNet.TL.Help;
using TeleDotNet.TL.Messages;
using TeleDotNet.TL.Upload;
using TeleDotNet.Core.Auth;
using TeleDotNet.Core.MTProto.Crypto;
using TeleDotNet.Core.Network;
using TeleDotNet.Core.Utils;
using TLAuthorization = TeleDotNet.TL.Auth.TLAuthorization;

namespace TeleDotNet.Core
{
    public class TelegramClient : IDisposable
    {
        ...
        {
            var r = new TeleDotNet.TL.Contacts.TLRequestSearch
            {
                Q = q,
                Limit = limit
            };
    ...
    {
        public const string InfoUrl = "https://github.com/sochix/TeleDotNet#quick-configuration";
